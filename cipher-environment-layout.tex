\startenvironment cipher-environment-layout
...
\setupbodyfont [serif,10pt] % 11 pt and 12pt -> errors due to intersection mess
...
% \setupTABLE
%   [row][odd] [background=color,backgroundcolor=darkyellow,]
% \setupTABLE
%   [row][even][]
